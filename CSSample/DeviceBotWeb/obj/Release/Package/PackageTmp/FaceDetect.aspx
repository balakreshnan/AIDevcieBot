<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FaceDetect.aspx.cs" Inherits="DeviceBotWeb.FaceDetect" Async="true" %>
    ...
    <form id="form1" runat="server">
       <div style="width:330px;float:left;">
            <table>
                ...
                <tr>
                    <td>
                        <p><button class="btn btn-small" id="btn1" onclick="base64_tofield()" >Detect Person</button></p>
