<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FaceTrain.aspx.cs" Inherits="DeviceBotWeb.FaceTrain" Async="true" %>
    ...
    <form id="form1" runat="server">
        <div style="width:330px;float:left;">
            <table>
                ...
                <tr>
                    <td>
                        <p><button class="btn btn-small" id="btn1" onclick="base64_tofield()" >Save Picture</button></p>
                        <p><textarea id="formfield" name="formfield" style="width:190px;height:70px;" hidden="hidden"></textarea></p>
                        <asp:TextBox ID="name" Text="Name Here" runat="server"></asp:TextBox>
                    </td>
                    <td>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <asp:Button ID="Button1" runat="server" Text="Train" OnClick="Button1_Click" />
                    </td>
                </tr>
            </table>
